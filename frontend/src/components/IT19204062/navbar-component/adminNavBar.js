        ...
        {!user && (
          <>
            <Toolbar>
              ...
              <Button color="inherit" href="/adminSignin">
                Login
              </Button>
            </Toolbar>
          </>
      ...
      >
        ...
        <List>
          ...
          <ListItem button component={Link} to="/viewSchedule">
            ...
            <ListItemText>View Shedules</ListItemText>
          </ListItem>
          <Divider />
          <Divider />
          <ListItem button component={Link} to="/paymentReport">
            <ListItemIcon>
              <CreditCardIcon className={classes.ico} />
            </ListItemIcon>
